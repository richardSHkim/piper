...
lerobot-record \
    ...
    --robot.cameras="{ rgb: {type: intelrealsense, serial_number_or_name: '323622272575', width: 848, height: 480, fps: 30}, fisheye: {type: opencv, index_or_path: 8, width: 640, height: 480, fps: 30}}" \
